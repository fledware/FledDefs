package fledware.definitions.builder.updater

import com.fasterxml.jackson.databind.ObjectMapper
import fledware.definitions.builder.updater.OUU.deepCopy
import fledware.definitions.builder.updater.OUU.getType
import fledware.definitions.builder.updater.OUU.isAllowedValueType
import fledware.definitions.builder.updater.OUU.isDirective
import fledware.definitions.builder.updater.OUU.isImmutableType
import fledware.definitions.builder.updater.OUU.otherAsList
import fledware.definitions.builder.updater.OUU.otherAsMap
import fledware.definitions.builder.updater.OUU.parentAsList
import fledware.definitions.builder.updater.OUU.parentAsMap
import fledware.definitions.builder.updater.OUU.parseRawCommandWithInput
import fledware.definitions.builder.updater.OUU.parseRawPathDirective
import fledware.definitions.builder.updater.OUU.toBaseType
import fledware.definitions.builder.updater.OUU.transverse
